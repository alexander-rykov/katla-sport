...
import { HiveSectionProductListComponent } from './hive-management/lists/hive-section-product-list/hive-section-product-list.component';
...
const routes: Routes = [
  ...
  { path: 'hive/:hiveId/section/:id/products', component: HiveSectionProductListComponent },
];
